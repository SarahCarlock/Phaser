...
class JumpScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "platform",
      "https://content.codecademy.com/courses/learn-phaser/Codey%20Jump/platform.png"
    );
    this.load.image(
      "stripe",
      "https://content.codecademy.com/courses/learn-phaser/Codey%20Jump/stripe.png"
    );
  ...
  create() {
    ...
    // takes five arguments .fillGradientStype(topLeft, topRight, bottomLeft, bottomRight, alpha);
    ...
    // Add the character animations: add in the animation called 'jump' that generates frames from the 'codey' spritesheet using frames 2 and 3
    this.anims.create({
      key: "jump",
