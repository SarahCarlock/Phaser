...
function fetchPage(page) {
  const pages = [
...

    {
      ...
      page: 17,
      narrative:
        "You act like nothing is wrong with what the knight is saying.",
      options: [{ option: "OK", nextPage: 22 }],
    },
...

    {
      ...
      page: 14,
      narrative:
        "Knight: You guess? Come on. An orc should be able to be independent.",
      options: [
...

    {
      ...
      page: 15,
      narrative:
        "You try explaining to the knight that you got cookies and a new friend.",
      options: [{ option: "OK", nextPage: 16 }],
    },
...

    {
      ...
      page: 3,
      narrative:
        "Orc: Look, I need some help. Can you help me or are you just going to stand there not saying anything?",
      options: [
...

    {
      ...
      page: 4,
      narrative:
        "Orc: Oh I see how it is. Look at the real hero here, slinking away from doing anything good.",
      options: [
...

    {
      ...
      page: 7,
      narrative:
        "You engage in passionate conversation with the orc, and discuss things like adults.",
      options: [{ option: "OK", nextPage: 9 }],
    },

    {
      ...
      options: [{ option: "Hello, wizard.", nextPage: 26 }],
    },
...

    {
      ...
      options: [{ option: "Wow", nextPage: 47 }],
    },
...

    {
      ...
      page: 27,
      narrative:
        "Wizard: There are many creatures to befriend here. Whose companionship do you desire?",
      options: [
...

    {
      ...
      options: [{ option: "Great", nextPage: 40 }],
    },

    {
      ...
      page: 40,
      narrative: "Knight: Hi.",
      options: [{ option: "Hi friend", nextPage: 42 }],
    },
...

    {
      ...
      options: [{ option: "That's fine", nextPage: 44 }],
    },

    {
      ...
      page: 44,
      narrative:
        "The Knight never calls, and it shouldn't really bother you but it does.",
      options: [{ option: "OK", nextPage: 45 }],
    },
...

    {
      ...
      page: 33,
      narrative:
        "You and the wizard continue engaging in small talk. You learn you grew up not far from each other.",
      options: [{ option: "OK", nextPage: 34 }],
    },

    {
      ...
      page: 34,
      narrative:
        "You have a couple mutual friends, in fact! You decide to hang out again next week.",
      options: [{ option: "OK", nextPage: 35 }],
    },
...

    {
      ...
      page: 28,
      narrative:
        "Wizard: Really? Seems like you were kinda standoffish to him earlier.",
      options: [
...

    {
      ...
      page: 9,
      narrative:
        "You leave the cave with a new outlook. Your radiant confidence makes a palpable positive impact on your life.\nTHE END",
      options: [{ option: "Play again", nextPage: 1 }],
    },
  ];
