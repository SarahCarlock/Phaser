let gameState = {
  ...
  class GameScene extends Phaser.Scene {
    ...
    preload() {
      const baseURL =
        "https://content.codecademy.com/courses/learn-phaser/electric-mouse/";
    ...
    create() {
      ...
      this.add.sprite(240, 320, "Background").setScale(0.5);
      ...
      gameState.attackButton = this.add
        .sprite(90, 550, "Attack")
        .setInteractive();
      gameState.defendButton = this.add
        .sprite(240, 550, "Defend")
        .setInteractive();
      gameState.specialButton = this.add
        .sprite(390, 550, "Special")
        .setInteractive();
      ...
      gameState.attackButton.on("pointerup", () => {
        ...
        if (game.input.enabled) {
          ...
          if (randomMove === 0) {
            gameState.information.text = `oh no! you both lost 1 hp!`;
            ...
            gameState.information.text = `Electric Mouse moves in with Attack! ${gameState.computerSprite.texture.key} loses 4 HP!`;
            gameState.playerMove.text = 'Attack!';
      ...
      gameState.defendButton.on("pointerup", () => {
        ...
        if (game.input.enabled) {
          ...
          if (randomMove === 0) {
            ...
            gameState.information.text = 'Defend! Defend! No HP lost!';
            gameState.playerMove.text = 'Defend!';
            gameState.computerMove.text = 'Defend!';
            gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
            gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
            ...
            gameState.information.text = 'Electric Mouse loses 4 HP!';
            gameState.playerMove.text = 'Defend!';
            gameState.computerMove.text = 'Special Attack';
